function share(sType){
	var sName = "Cosmic Rush";
	var  title='Hosuke',
    _wset = 320,
    _hset = 400,
    _w = 320,
    _h = 400,
    _strGamePic="http://cosmicrush.io/assets/screenshot.png";
	...
	var sContent=['我在 NOT IE 里玩了',highscore.toString(),'分，你能得多少分呢？ 现在就来挑战一下吧！http://hosuke.github.io/NotIE/ @Hosuke'].join('');
    var sContentEN=['I scored ',highscore.toString(),' points in Cosmic Rush! Join and play with me!'].join('');
    var fbContent = 'I%20scored%20'+ highscore.toString() +'%20in%20NOT%20IE%20!%20Can%20you%20beat%20me%3F';
	...
	{
		sUrl=['https://twitter.com/intent/tweet?original_referer=',en('http://cosmicrush.io'),'&url=http%3A%2F%2Fcosmicrush.io&text=',en(sContentEN),'&via=',en('HuangGeyang'),'&hashtags=',en('COSMICRUSH')].join('');
		w=700;
		h=470;
		statFlag='tqq';
	}
